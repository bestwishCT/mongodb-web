...
public class RWExcel {
	...
	public RWExcel(String filePath){
		this.filePath = filePath;
	}
	...
	public static void main(String[] args) {
		 //读取同一个excel 里面2个sheet
//		 RWExcel excel = new RWExcel("E:\\tmp\\testexcel\\111.xls", "E:\\tmp\\testexcel\\111.xls");
		RWExcel excel = new RWExcel("E:\\tmp\\testexcel\\111.xls");
